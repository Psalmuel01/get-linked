...
// import back_button from "../assets/back_button.svg"; //linkedin temp
...
const ContactPage = () => {
  ...
  return (
    <div className="bg-[#150E28] hidden text-white mont">
      <div className="block md:hidden">
        <div className="px-[50px] pt-12">
          <img src={linkedin} alt="back_btn image" className="" />
        </div>
      </div>
        ...
        <div className="block md:flex gap-4">
          <div className="border-xl w-full hidden md:block mx-auto rounded-xl shadow-[0px 4px 4px 0px rgba(0, 0, 0, 0.25)] px-16 md:py-20 mt-10">
            <div className="mb-10">
              ...
              <p className="text-2xl text-red bg-blue-400">Sam here</p>
              {/* removeeeee */}
            </div>
            <div className="mb-5">
